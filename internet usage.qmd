...
```{r Comparison Graph}
ggplot(rearranged_country, aes(x = fct_rev(fct_inorder(Country)), y = Value, fill = as.factor(Year))) +
...
The maps compare internet access in 2014 and 2022 in the NUTS Regions. 50% improvement in the North West Belgium. In Romania, regions such as South-Muntenia, South-West Oltenia, North-East and Center, had more than 35% improvement.
:::
