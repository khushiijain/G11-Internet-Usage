...
According to a Eurostat survey in 2021, Netherlands had the highest shares of internet users who bought or ordered goods or services over the internet in the 12 months prior to the survey were recorded in the Netherlands (94%)3. The primary focus is on the relationship between the dependent variable "Value" and the independent variables "*I_IUIF*- finding information about goods and services" and "*I_IUSELL* - selling goods or services." We choose the individuals categorized as *SAL_SELF_FAM-* employees, self-employed, family workers.
...
-   The linear model suggests that "I_IUIF" significantly influences the dependent variable "Value," while "I_IUSELL" does not exhibit a statistically significant effect. These findings provide insights into the online shopping patterns in the Netherlands, emphasizing the importance of certain factors in determining the value of online transactions.

The graph represents the correlation between the proportion of individuals engaged in online selling and those utilizing the internet to seek information on goods and services. Despite a consistent upward trend in the percentage of individuals expressing interest in information retrieval, the same pattern is not observed in the domain of commercial activities.

This discrepancy sheds light on a crucial aspect of e-sellers' behavior. Notably, there has been a noticeable improvement in the percentage over the past three years, with the lockdown period emerging as a significant contributing factor to this shift.
...
There is a clear increase in internet usage across most types between 2019-2022. There has been a more than 30% increase in the percentage of individuals accessing an online learning material (*I_IUOLM*), likely attributed to the increased accessibility for remote learning following the Covid-19 pandemic.
...
With the European retirement age set at above 60 years, that age category makes up a large portion of the retired or other indicator type. As such, this conclusion can also be applied to the employment status. 
