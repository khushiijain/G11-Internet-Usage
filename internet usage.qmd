...
**Exploring Internet Usage Patterns:**

**A Comprehensive Analysis across European Regions and Countries**

Is there a link between country population and type of internet usage? This research aims to conduct a comprehensive analysis of internet usage patterns in Europe. Focusing on individual behaviors related to health information seeking, online learning, and gaming, the study explores the influence of age, gender, and employment status. Additionally, it examines internet access at regional and national levels, along with broadband coverage and speeds over time.
...
In Luxembourg, Netherlands and Denmark, 98% of households had internet access in 2022. The increment in Greece was of 50 percentage points, from 53.58% in 2012 to 85.49 % in 2022.
...
The maps compare internet access in 2014 and 2022 in the NUTS 2 Regions. 50% increment in the North West Belgium. In Romania, regions such as South-Muntenia, South-West Oltenia, North-East and Center, had a more than 35% improvement.
...
Regional level data shows similar trends, with all Austrian regions exhibiting a near logarithmic growth.
...
There is a clear increase in internet usage across most types between 2019-2022. There has been a more than 30% increase in the percentage of individuals accessing an online learning material (*I_IUOLM*), likely also attributed to the increased accessibility for remote learning following the lockdown during the Covid-19 pandemic.
...
### Online Shopping Patterns: Netherlands Linear Model Analysis

According to a Eurostat survey in 2021, Netherlands had the highest shares of internet users who bought or ordered goods or services over the internet in the 12 months prior to the survey were recorded in the Netherlands (94%). The primary focus is on the relationship between the dependent variable "Value" and the independent variables "*I_IUIF* - finding information about goods and services" and "*I_IUSELL* - selling goods or services." We choose the individuals categorized as *SAL_SELF_FAM* - employees,  self-employed,  family workers.
...
Luxembourg, the Netherlands, and Denmark emerge as front-runners. The analysis within the countries and regions give results on different demographical aspects. Overall, the positive trends observed at both country and regional levels reflect the concerted efforts and advancements in digital infrastructure and literacy initiatives across European Union member states.
